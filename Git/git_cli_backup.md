...
### 9. git과 오픈소스
  - #### 9-1. 정리
    * 오픈소스 내려받는 방법
      1. git clone
      2. zip파일
    * 수많은 오픈소스들이 git으로 만들어 지고 있고 github나 gitlab과 같은 사이트를 통해 hosting 되어지고 있음 
    * git을 사용할 수 있다는 것은 오픈소스를 사용할 준비가 되어있다라는 것이므로 앞으로 공부를 더 해보자 ㅋㅋ
