# 깃허브 저장소 삭제하기(웹)
  ...
  5. 저장소 이름 복사해서 붙여 넣기
    <p align="center"><img src="/img/github/delete_repository2.png" width="80%" height="80%" title="저장소삭제절차3"></img></p>

  6. I understand the consequences, delete this repository 버튼 클릭

  7. github 계정 비밀번호 입력 후 Confirm password 버튼 클릭
    <p align="center"><img src="/img/github/delete_repository3.png" width="80%" height="80%" title="저장소삭제절차4"></img></p>
